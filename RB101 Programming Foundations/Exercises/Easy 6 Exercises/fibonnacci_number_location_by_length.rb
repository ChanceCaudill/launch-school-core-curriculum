...
# Computationally, the Fibonacci series is a very simple 
# series, but the results grow at an incredibly rapid rate. 
...
def find_fibonacci_index_by_length(digits)
  ...
  loop do
    start_fib[counter] = start_fib[counter - 1] + start_fib[counter - 2]
    counter += 1
    break if start_fib[-1].digits.size >= digits
  end
